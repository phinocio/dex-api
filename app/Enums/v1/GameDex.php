...
enum GameDex: int
{
    ...
    public function type(): string
    {
        return match ($this) {
            ...
            self::GEN_7_NATIONAL, self::HOME_NATIONAL, => DexType::NATIONAL->value,
            ...
            self::GEN_7_GENERATIONAL, self::GEN_8_GENERATIONAL, self::GEN_9_GENERATIONAL, => DexType::GENERATIONAL->value,
            ...
            self::SV_TM_REGIONAL, self::SV_ID_REGIONAL, => DexType::REGIONAL->value,
        };
    }
}
