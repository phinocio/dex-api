...
return [
    'game_dex_mappings' => [
        ...
        Game::DIAMOND->value => [GameDex::DP_REGIONAL->value, GameDex::DPPT_HGSS_NATIONAL, GameDex::DPPT_GENERATIONAL->value],
        Game::PEARL->value => [GameDex::DP_REGIONAL->value, GameDex::DPPT_HGSS_NATIONAL, GameDex::DPPT_GENERATIONAL->value],
        Game::PLATINUM->value => [GameDex::PT_REGIONAL->value, GameDex::DPPT_HGSS_NATIONAL->value, GameDex::DPPT_GENERATIONAL->value],
        Game::HEART_GOLD->value => [GameDex::HGSS_REGIONAL->value, GameDex::DPPT_HGSS_NATIONAL->value, GameDex::HGSS_GENERATIONAL->value],
        Game::SOUL_SILVER->value => [GameDex::HGSS_REGIONAL->value, GameDex::DPPT_HGSS_NATIONAL->value, GameDex::HGSS_GENERATIONAL->value],
        Game::BLACK->value => [GameDex::BW_REGIONAL, GameDex::BW_B2W2_NATIONAL->value, GameDex::BW_B2W2_GENERATIONAL->value],
        Game::WHITE->value => [GameDex::BW_REGIONAL, GameDex::BW_B2W2_NATIONAL->value, GameDex::BW_B2W2_GENERATIONAL->value],
        Game::BLACK_2->value => [GameDex::B2W2_REGIONAL, GameDex::BW_B2W2_NATIONAL->value, GameDex::BW_B2W2_GENERATIONAL->value],
        Game::WHITE_2->value => [GameDex::B2W2_REGIONAL, GameDex::BW_B2W2_NATIONAL->value, GameDex::BW_B2W2_GENERATIONAL->value],
        Game::X->value => [GameDex::XY_REGIONAL->value, GameDex::XY_ORAS_NATIONAL->value, GameDex::XY_GENERATIONAL->value],
        Game::Y->value => [GameDex::XY_REGIONAL->value, GameDex::XY_ORAS_NATIONAL->value, GameDex::XY_GENERATIONAL->value],
        Game::OMEGA_RUBY->value => [GameDex::ORAS_REGIONAL->value, GameDex::XY_ORAS_NATIONAL->value, GameDex::ORAS_GENERATIONAL->value],
        Game::ALPHA_SAPPHIRE->value => [GameDex::ORAS_REGIONAL->value, GameDex::XY_ORAS_NATIONAL->value, GameDex::ORAS_GENERATIONAL->value],
        ...
        Game::ULTRA_SUN->value => [GameDex::SM_REGIONAL->value, GameDex::SM_USUM_NATIONAL->value, GameDex::SM_USUM_GENERATIONAL->value],
        Game::ULTRA_MOON->value => [GameDex::SM_REGIONAL->value, GameDex::SM_USUM_NATIONAL->value, GameDex::SM_USUM_GENERATIONAL->value],
